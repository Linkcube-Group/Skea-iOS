...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        self.viewBlack = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 320, 0)];
        self.viewBlack.backgroundColor = RGBColor(20, 25, 36);
        [self addSubview:self.viewBlack];
        self.backgroundColor = RGBColor(20, 25, 36);
...
{
    if (self.isChat) {
        CGPoint p = self.arrowImage.center;
        p.x = self.center.x;
        self.arrowImage.center = p;
    }
    // 当前的contentOffset
    ...
    if (currentOffsetY<=0) {
        self.viewBlack.originY = currentOffsetY;
        self.viewBlack.height = -currentOffsetY;
    }
            ...
            if (MJRefreshStateRefreshing == oldState) {
                ...
                [UIView animateWithDuration:MJRefreshSlowAnimationDuration animations:^{
                    if (!isIOS7) {
                        ...
                        self.scrollView.mj_contentInsetTop = 64;
                    }
